...
const { issueEsdt, mintBurnEsdt, sendEsdt, toggleEsdtRoles, freezeUnfreezeEsdt, wipeEsdt, transferEsdtOwnership, changeEsdtProperties } = require('../controllers/esdt.controller');
 ...
 *                 items:
 *                   type: string
 *                   enum, ESDTRoleNFTUpdateAttributes]
 *               action:
 *                 type: string
 *                 enum, unset]
