...
import {
  ...
  sendMetaEsdt,
  toggleMetaEsdtRoles,
  changeMetaEsdtProperties
} from '../controllers/meta-esdt.controller';
 ...
 *                 items:
 *                   type: string
 *                   enum: [ESDTRoleNFTCreate, ESDTRoleNFTBurn, ESDTRoleNFTUpdateAttributes, ESDTRoleNFTAddQuantity, ESDTTransferRole]
 *               action:
 *                 type: string
 *                 enum: [set, unset]
